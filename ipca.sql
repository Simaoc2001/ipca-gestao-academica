...
INSERT INTO `ficha_aluno` (`login`, `nome_completo`, `email`, `telefone`, `morada`, `data_nascimento`, `foto`, `curso_id`, `estado`, `data_submissao`, `data_validacao`, `validado_por`) VALUES
...
-- Matrícula do aluno1 - aprovada no curso DWM (2.ª opção: Redes)
INSERT INTO `pedidos_matricula` (`login_aluno`, `curso_id`, `curso_id2`, `curso_id3`, `data_pedido`, `estado`, `data_decisao`, `decisor_login`) VALUES
('aluno1', 1, 3, NULL, '2026-02-13 09:00:00', 'aprovado', '2026-02-14 11:30:00', 'Funcionario1');

-- Pautas de exemplo - disciplinas do 1.º ano DWM (Época Normal)
INSERT INTO `pautas` (`id`, `disciplina_id`, `epoca_id`, `ano_letivo`, `criado_por`) VALUES
...
-- Notas do aluno1
INSERT INTO `notas` (`pauta_id`, `aluno_login`, `nota`, `lancado_por`) VALUES
